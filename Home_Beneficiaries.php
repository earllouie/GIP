...
<html class="no-js" lang="en">
  ...
  <!-- Off Canvas Menu -->
          <div id="offCanvasLeft" class="off-canvas position-left hide-for-large" data-off-canvas data-position="left">
			...
			<li class="active"><a href="Home_Beneficiaries.php">List of Beneficiaries</a></li>
	...
	<div class="row">
            ...
            <table class="scroll">
                <thead class="table-info">
                 <th scope="col" class="bg-primary">REGION</th>
                 <th scope="col" class="bg-primary">PROVINCE</th>
                 <th scope="col" class="bg-primary">GIP ID NO</th>
				 <th scope="col" class="bg-primary">FULL NAME</th>
				 <th scope="col" class="bg-primary">SEX</th>
				 <th scope="col" class="bg-primary">INSTITUTION</th>
                </thead>
                <tbody><tr>
					<?php
				...
				<?php for ($page = 1; $page <= $total_pages ; $page++):?>
					...
					<?php  echo "<div class='text-center'>".$page."</div>"; ?>
					</a>
				<?php endfor; ?>
